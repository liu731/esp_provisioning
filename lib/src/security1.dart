...
class Security1 implements Security {
  final String pop;
  bool verbose = false;
  SecurityState sessionState = SecurityState.REQUEST1;
  ...
  Future<void> _generateKey() async {
    ...
    clientKey = (await algorithm.newKeyPair()) as SimpleKeyPairData;
  }
  ...
  setup1Response(SessionData responseData) async {
